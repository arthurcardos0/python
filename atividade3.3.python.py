...
while sim == "S":
    ...
    print("A soma do número 1 + número 2 é: ", resultado)
    print("A subtração do número 1 - número 2 é: ", resultado1)
    print("A multiplicação do número 1 * número 2 é: ", resultado2)
    print("A divisão do número 1 / número 2 é: ", resultado3)
    print("O resto da divisão do número 1 % número 2 é: ", resultado4)
    print("A potência do número 1 ** número 2 é: ", resultado5)
